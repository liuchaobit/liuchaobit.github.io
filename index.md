...
Currently, my research is focused on the development of modeling and control methods designed for multi-body under-actuated flight vehicle systems. Traditional approaches to multi-body systems have often relied on local-coordinate descriptions and controllers designed in local charts. However, our research introduces a more concise and straightforward global formulation for describing multi-body systems, which integrates the systems' intrinsic properties. By employing this intrinsic modeling method, we propose a guidance and control approach that capitalizes on the system's inherent properties.
